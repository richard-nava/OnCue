...
<body>
		...
		<div class="container">
			<div class="card org-card mb-3">
				...
				<div class="card-body text-center">
					<h4 class="card-title">${org.orgName} 
					Settings</h4>
					<p class="card-text">
	...
	<div class="container">
		<div class="card">
		<div class="card-body add-image">
		<h5 class="card-title">Organization Image</h5>
			<form action="addimages" method="post" enctype="multipart/form-data">
				<input type="hidden" name="id" value="${org.id}"> <input
					type="file" name="file" accept="image/png image/jpg">
		...
		<table class="table">
			...
			<c:forEach var="i" items="${classesOffered}">
				<tr>
					...
					<td><a id="${i.class_id}" href="class-page?id=${i.class_id}">${i.class_name}</a>
					</td>
					<td>${i.students.size()}</td>
				</tr>
			</c:forEach>
		</table>
	</div>
